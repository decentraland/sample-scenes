...
var Buffer = exports.global = __webpack_require__(28);
...
var BufferArray = exports.Array = __webpack_require__(29);
var BufferBuffer = exports.Buffer = __webpack_require__(30);
var BufferUint8Array = exports.Uint8Array = __webpack_require__(31);
...
/* harmony export (immutable) */ __webpack_exports__["EventDispatcherBinding"] = EventDispatcherBinding;
...
var ExtBuffer = __webpack_require__(7).ExtBuffer;
var ExtPacker = __webpack_require__(33);
var WriteType = __webpack_require__(34);
...
var BufferLite = __webpack_require__(32);
...
var ExtBuffer = __webpack_require__(7).ExtBuffer;
var ExtUnpacker = __webpack_require__(36);
var readUint8 = __webpack_require__(18).readUint8;
var ReadToken = __webpack_require__(37);
var CodecBase = __webpack_require__(3);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Script__ = __webpack_require__(23);
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "inject", function() { return __WEBPACK_IMPORTED_MODULE_0__Script__["c"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "getInjectedAPIs", function() { return __WEBPACK_IMPORTED_MODULE_0__Script__["b"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Script", function() { return __WEBPACK_IMPORTED_MODULE_0__Script__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__EventSubscriber__ = __webpack_require__(43);
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "EventSubscriber", function() { return __WEBPACK_IMPORTED_MODULE_1__EventSubscriber__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_transports_WebWorker__ = __webpack_require__(20);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "WebWorkerTransport", function() { return __WEBPACK_IMPORTED_MODULE_2__common_transports_WebWorker__["WebWorkerTransport"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_transports_WebSocket__ = __webpack_require__(44);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "WebSocketTransport", function() { return __WEBPACK_IMPORTED_MODULE_3__common_transports_WebSocket__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_transports_Memory__ = __webpack_require__(45);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MemoryTransport", function() { return __WEBPACK_IMPORTED_MODULE_4__common_transports_Memory__["a"]; });
new Function(`
...
var EncodeBuffer = __webpack_require__(13).EncodeBuffer;
...
var preset = __webpack_require__(6).preset;

var FlexEncoder = __webpack_require__(15).FlexEncoder;
...
var DecodeBuffer = __webpack_require__(17).DecodeBuffer;
...
var FlexDecoder = __webpack_require__(15).FlexDecoder;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["WebWorkerTransport"] = WebWorkerTransport;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sdk__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sdk___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__sdk__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dcl_scripting__ = __webpack_require__(11);
...
class CrocsGame extends __WEBPACK_IMPORTED_MODULE_0__sdk__["Script"] {
    constructor() {
        super(...arguments);
        this.entities = null;
        this.sound = null;
    ...
    async systemDidEnable() {
        this.eventSubscriber = new __WEBPACK_IMPORTED_MODULE_1_dcl_scripting__["EventSubscriber"](this.entities);
    ...
    async newRound() {
        ...
        for (let i = 0; i < this.difficulty; i++) {
            this.sequence.push('croc_' + Math.floor(Math.random() * 4));
        }
...
/* harmony export (immutable) */ __webpack_exports__["CrocsGame"] = CrocsGame;

__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__sdk__["inject"])('EntityController'),
    __metadata("design:type", Object)
], CrocsGame.prototype, "entities", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__sdk__["inject"])('experimentalSoundController'),
    __metadata("design:type", Object)
], CrocsGame.prototype, "sound", void 0);
const theSystem = new CrocsGame(Object(__WEBPACK_IMPORTED_MODULE_0__sdk__["WebWorkerTransport"])(self));
/* harmony export (immutable) */ __webpack_exports__["theSystem"] = theSystem;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = getInjectedAPIs;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_json_rpc_Client__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_json_rpc_API__ = __webpack_require__(42);
...
class Script extends __WEBPACK_IMPORTED_MODULE_0__common_json_rpc_Client__["a" /* Client */] {
    ...
    async loadAPIs(apiName) {
        ...
        if (keysToRequest.length) {
            ...
            keysToRequest.forEach(async (apiName) => {
                this.loadedAPIs[apiName] = Object(__WEBPACK_IMPORTED_MODULE_1__common_json_rpc_API__["a" /* getApi */])(this, apiName);
            });
        }
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_EventDispatcher__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_msgpack_lite__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_msgpack_lite___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_msgpack_lite__);


const codec = Object(__WEBPACK_IMPORTED_MODULE_1_msgpack_lite__["createCodec"])();
class Client extends __WEBPACK_IMPORTED_MODULE_0__core_EventDispatcher__["EventDispatcher"] {
    constructor(opts) {
        super();
    ...
    processMessage(messageStr) {
        ...
        if (typeof messageStr === 'string' && messageStr.charAt(0) === '{') {
            ...
            message = Object(__WEBPACK_IMPORTED_MODULE_1_msgpack_lite__["decode"])(messageStr, { codec });
        }
        else {
            message = messageStr;
        }
    ...
    _send(message) {
        if (this.sendEncoding === 'msgpack') {
            this._requestQueue.push(Object(__WEBPACK_IMPORTED_MODULE_1_msgpack_lite__["encode"])(message, { codec }));
        }
        else {
...
exports.encode = __webpack_require__(12).encode;
exports.decode = __webpack_require__(16).decode;

exports.Encoder = __webpack_require__(38).Encoder;
exports.Decoder = __webpack_require__(39).Decoder;

exports.createCodec = __webpack_require__(40).createCodec;
...
function encode(input) {
  if (!_encode) _encode = __webpack_require__(12).encode; // lazy load
...
var Bufferish = __webpack_require__(0);
var BufferProto = __webpack_require__(8);
var WriteToken = __webpack_require__(35);
var uint8 = __webpack_require__(14).uint8;
var ExtBuffer = __webpack_require__(7).ExtBuffer;
...
var ReadFormat = __webpack_require__(18);
...
var EventLite = __webpack_require__(19);
var EncodeBuffer = __webpack_require__(13).EncodeBuffer;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getApi;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_core_EventDispatcher__ = __webpack_require__(2);

class EventSubscriber extends __WEBPACK_IMPORTED_MODULE_0__common_core_EventDispatcher__["EventDispatcher"] {
    ...
    off(event) {
        ...
        else if (event instanceof __WEBPACK_IMPORTED_MODULE_0__common_core_EventDispatcher__["EventDispatcherBinding"]) {
            event = event.event;
        }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = WebSocketTransport;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = MemoryTransport;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_EventDispatcher__ = __webpack_require__(2);

function MemoryTransport() {
    const clientEd = new __WEBPACK_IMPORTED_MODULE_0__core_EventDispatcher__["EventDispatcher"]();
    const serverEd = new __WEBPACK_IMPORTED_MODULE_0__core_EventDispatcher__["EventDispatcher"]();
